...
export default function PrivacyPolicyPage() {
  return (
    <PageLayout>
      ...
      {/* Privacy Content */}
      <div className="max-w-4xl w-full mx-auto my-12 p-8 bg-[#D8CDBA] rounded-2xl shadow-lg">
        <div className="prose prose-lg max-w-none text-gray-800">
          <p className="lead">
            This Privacy Policy describes how I Ching Divination ("we", "our",
            or "us") collects, uses, and discloses your personal information
