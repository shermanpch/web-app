...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center">
      <Container>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-[hsl(var(--muted-foreground))] mb-12 max-w-3xl mx-auto">
            Access comprehensive technical documentation, code examples, and
            best practices all in one place. Let AI help you find exactly what
            you need.
          </p>
          ...
          <div className="text-center mb-4">
            <p className="text-sm text-[hsl(var(--muted-foreground))] uppercase tracking-wider mb-4">
              SELECT A PROMPT
            </p>
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-[hsl(var(--background))] -z-10"
      ></div>
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-[url('/grid.svg')] bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))] opacity-20 dark:opacity-100 -z-10"
      ></div>
    </section>
  );
};
