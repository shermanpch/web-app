  ...
  const features: FeatureProps[] = [
    {
      ...
      description: 'Your application will look great on any device, from desktop to mobile.',
      icon: (
    ...
    },
    {
      ...
      description: 'Build your UI with reusable components that maintain consistency across your app.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    {
      title: 'Dark Mode',
      description: 'Built-in dark mode support that respects user preferences and enhances UX.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    {
      title: 'Accessibility',
      description: 'Accessible components that follow WAI-ARIA standards for inclusive experiences.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    },
    {
      ...
      description: 'Full TypeScript support with proper typing for better development experience.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
